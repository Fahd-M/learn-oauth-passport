...
const ProfilePage = () => {
  ...
  useEffect(() => {
    ...
    axios
        ...
        // Update the state: done authenticating, user NOT logged in
                setIsAuthenticating(false);
                setIsLoggedIn(false);
            } else {
    ...
    // alternatively can make this a preloader
    ...
    return (
        ...
        //if user not logged in render a login button ( condition ? true : false )
                    <>
                        <p>
